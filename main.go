...
var (
	...
	key    = flag.String("key", "zitadel-key.json", "path to your key.json")
...
func main() {
	...
	app := zitadel.New(*domain, zitadel.WithInsecure("8080"))
	authZ, err := authorization.New(ctx, app, oauth.DefaultAuthorization(*key))
	if err != nil {
